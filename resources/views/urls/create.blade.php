    ...
    <div class="container-lg mt-3">
      <div class="row">
        <div class="col-12 col-md-10 col-lg-8 mx-auto border rounded-3 bg-light p-5">
          ...
          <!-- <form class="d-flex justify-content-center" action="{{ url('url') }}" method="POST" class="form-horizontal"> -->
          <form class="d-flex justify-content-center" action="/urls" method="POST" class="form-horizontal">
          @csrf
           
      {{ csrf_field() }}
      <!-- Имя сайта -->
            <input class="form-control form-control-lg" type="text" name="url[name]" placeholder="https://www.example.com">
